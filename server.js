...
// ✅ Автоматически определяем, какой фронтенд разрешить
const allowedOrigins = [
  process.env.FRONTEND_URL || "http://localhost:5173", // Используем переменную окружения или локальный фронтенд
];
...
app.use(
  cors({
    origin: allowedOrigins, // ✅ Разрешаем только свой фронтенд
